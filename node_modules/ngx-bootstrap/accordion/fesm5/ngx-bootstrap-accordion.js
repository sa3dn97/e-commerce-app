...
var AccordionConfig = /** @class */ (function () {
    ...
    /** @nocollapse */ AccordionConfig.ɵfac = function AccordionConfig_Factory(t) { return new (t || AccordionConfig)(); };
    /** @nocollapse */ AccordionConfig.ɵprov = ɵɵdefineInjectable({ token: AccordionConfig, factory: AccordionConfig.ɵfac });
    return AccordionConfig;
}());
/*@__PURE__*/ (function () { ɵsetClassMetadata(AccordionConfig, [{
        type: Injectable
    }], null, null); })();
...
var AccordionComponent = /** @class */ (function () {
    ...
    /** @nocollapse */ AccordionComponent.ɵfac = function AccordionComponent_Factory(t) { return new (t || AccordionComponent)(ɵɵdirectiveInject(AccordionConfig)); };
    /** @nocollapse */ AccordionComponent.ɵcmp = ɵɵdefineComponent({ type: AccordionComponent, selectors: [["accordion"]], hostAttrs: ["role", "tablist", 1, "panel-group", 2, "display", "block"], hostVars: 1, hostBindings: function AccordionComponent_HostBindings(rf, ctx) { if (rf & 2) {
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(AccordionComponent, [{
        type: Component,
        args: [{
                selector: 'accordion',
...
function AccordionPanelComponent_button_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction1(2, _c0$1, ctx_r1.isDisabled));
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", ctx_r1.heading, " ");
} }
...
var AccordionPanelComponent = /** @class */ (function () {
    ...
    /** @nocollapse */ AccordionPanelComponent.ɵfac = function AccordionPanelComponent_Factory(t) { return new (t || AccordionPanelComponent)(ɵɵdirectiveInject(AccordionComponent)); };
    /** @nocollapse */ AccordionPanelComponent.ɵcmp = ɵɵdefineComponent({ type: AccordionPanelComponent, selectors: [["accordion-group"], ["accordion-panel"]], hostAttrs: [1, "panel", 2, "display", "block"], hostVars: 2, hostBindings: function AccordionPanelComponent_HostBindings(rf, ctx) { if (rf & 2) {
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(AccordionPanelComponent, [{
        type: Component,
        args: [{
...
var AccordionModule = /** @class */ (function () {
    ...
    /** @nocollapse */ AccordionModule.ɵmod = ɵɵdefineNgModule({ type: AccordionModule });
    /** @nocollapse */ AccordionModule.ɵinj = ɵɵdefineInjector({ factory: function AccordionModule_Factory(t) { return new (t || AccordionModule)(); }, imports: [[CommonModule, CollapseModule]] });
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(AccordionModule, [{
        type: NgModule,
        args: [{

...
function TabsetComponent_li_1_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function TabsetComponent_li_1_span_4_Template_span_click_0_listener($event) { ɵɵrestoreView(_r5); const tabz_r1 = ɵɵnextContext().$implicit; const ctx_r4 = ɵɵnextContext(); $event.preventDefault(); return ctx_r4.removeTab(tabz_r1); });
    ɵɵtext(1, " \u274C");
    ɵɵelementEnd();
} }

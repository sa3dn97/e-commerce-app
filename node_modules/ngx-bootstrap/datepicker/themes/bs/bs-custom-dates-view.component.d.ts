...
export declare class BsCustomDatesViewComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDefWithMeta<BsCustomDatesViewComponent, "bs-custom-date-view", never, { "ranges": "ranges"; "selectedRange": "selectedRange"; }, { "onSelect": "onSelect"; }, never, never>;
}
